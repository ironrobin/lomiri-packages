...
for i in "accountsservice-ubuntu" "qt5-pim-git" "telepathy-farstream" "telepathy-qt-git" "lomiri-history-service-git" "properties-cpp" "dbus-test-runner" "click-git" "cmake-extras-git" "qdjango-git" "libqtdbustest-git" ; do
	status=13
